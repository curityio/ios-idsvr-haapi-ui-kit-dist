...
#ifndef IDSVRHAAPIUIKIT_SWIFT_H
#define IDSVRHAAPIUIKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="IdsvrHaapiUIKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit11AccessToken") SWIFT_AVAILABILITY(ios,introduced=14)
...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit24AttestationConfiguration") SWIFT_AVAILABILITY(ios,introduced=14.0)
...
SWIFT_PROTOCOL("_TtP15IdsvrHaapiUIKit23TokenBoundConfiguration_") SWIFT_AVAILABILITY(ios,introduced=14.0)
...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit25BoundedTokenConfiguration") SWIFT_AVAILABILITY(ios,introduced=14.0)
...
SWIFT_PROTOCOL("_TtP15IdsvrHaapiUIKit26ClientAuthenticationMethod_")
@protocol ClientAuthenticationMethod
@end

enum JWTAsymmetricAlgorithm : NSInteger;
@class NSBundle;
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit39ClientAuthenticationMethodJWTAsymmetric") SWIFT_AVAILABILITY(ios,introduced=14.0)
...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit38ClientAuthenticationMethodJWTSymmetric") SWIFT_AVAILABILITY(ios,introduced=14.0)
...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit30ClientAuthenticationMethodMTLS") SWIFT_AVAILABILITY(ios,introduced=14.0)
...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit30ClientAuthenticationMethodNone")
...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit32ClientAuthenticationMethodSecret")
...
///
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit16DCRConfiguration") SWIFT_AVAILABILITY(ios,introduced=14)
...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit4Dpop") SWIFT_AVAILABILITY(ios,introduced=14)
...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit19DpopAccessTokenInfo") SWIFT_AVAILABILITY(ios,introduced=14)
...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit22HTTPURLResponseContent")
...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit27ErrorHTTPURLResponseContent")
...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit18ErrorTokenResponse") SWIFT_AVAILABILITY(ios,introduced=14.0)
...
///
/// \endcode
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit5Haapi")
...
SWIFT_PROTOCOL("_TtP15IdsvrHaapiUIKit20HaapiManagerAccessor_") SWIFT_AVAILABILITY(ios,introduced=14.0)
...
SWIFT_PROTOCOL("_TtP15IdsvrHaapiUIKit13OAuthAccessor_") SWIFT_AVAILABILITY(ios,introduced=14.0)
...
SWIFT_PROTOCOL("_TtP15IdsvrHaapiUIKit13HaapiAccessor_") SWIFT_AVAILABILITY(ios,introduced=14.0)
...
///
/// \endcode
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit20HaapiAccessorBuilder") SWIFT_AVAILABILITY(ios,introduced=14.0)
...
SWIFT_UNAVAILABLE
@interface HaapiAccessorBuilder (SWIFT_EXTENSION(IdsvrHaapiUIKit))
...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit11HaapiClient") SWIFT_AVAILABILITY(ios,introduced=14.0)
...
SWIFT_PROTOCOL("_TtP15IdsvrHaapiUIKit22OAuthTokenConfigurable_") SWIFT_AVAILABILITY(ios,introduced=14.0)
...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit18HaapiConfiguration") SWIFT_AVAILABILITY(ios,introduced=14.0)
@interface HaapiConfiguration : NSObject <OAuthTokenConfigurable>
...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit23HaapiFlowViewController") SWIFT_AVAILABILITY(ios,introduced=14.0)
@interface HaapiFlowViewController : UIViewController
...
@interface HaapiFlowViewController (SWIFT_EXTENSION(IdsvrHaapiUIKit)) <ASWebAuthenticationPresentationContextProviding>
...
SWIFT_AVAILABILITY(ios,introduced=14.0)
@interface HaapiFlowViewController (SWIFT_EXTENSION(IdsvrHaapiUIKit)) <UIAdaptivePresentationControllerDelegate>
...
/// An <code>HaapiFlowViewModel</code> is responsible for storing state and managing interactions with the server during the HaapiFlow execution.
/// remark:
/// When instantiating an <code>HaapiFlowViewController</code>,  an <code>HaapiFlowViewModel</code> is created.
/// note:
/// It is impossible to have multiple instances of <code>HaapiFlowViewModel</code> in use at the same time when using the same
/// <code>haapiUIKitConfiguration</code>. By trying to have multiple instances of <code>HaapiFlowViewModel</code> using the same configuration, the second will throw an error.
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit18HaapiFlowViewModel") SWIFT_AVAILABILITY(ios,introduced=14.0)
@interface HaapiFlowViewModel : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

/// Logger for Haapi.
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit11HaapiLogger")
...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit12HaapiManager") SWIFT_AVAILABILITY(ios,introduced=14.0)
...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit17HaapiTokenManager") SWIFT_AVAILABILITY(ios,introduced=14.0)
...
SWIFT_AVAILABILITY(ios,introduced=14.0)
@interface HaapiTokenManager (SWIFT_EXTENSION(IdsvrHaapiUIKit))
...
///
/// \endcode
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit24HaapiTokenManagerBuilder") SWIFT_AVAILABILITY(ios,introduced=14.0)
...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit16HaapiTokenResult") SWIFT_AVAILABILITY(ios,introduced=14)
...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit10KeyPinning") SWIFT_AVAILABILITY(ios,introduced=14.0)
...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit7Message") SWIFT_AVAILABILITY(ios,introduced=14.0)
...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit8Metadata") SWIFT_AVAILABILITY(ios,introduced=14.0)
...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit28OAuthAuthorizationParameters") SWIFT_AVAILABILITY(ios,introduced=14.0)
...
SWIFT_PROTOCOL("_TtPC15IdsvrHaapiUIKit17OAuthTokenManager29TokenEndpointResponseListener_")
@protocol TokenEndpointResponseListener
...
SWIFT_UNAVAILABLE
@interface OAuthTokenManager (SWIFT_EXTENSION(IdsvrHaapiUIKit))
...
///
- (void)fetchAccessTokenWith:(NSString * _Nonnull)authorizationCode dpop:(Dpop * _Nullable)dpop additionalParameters:(NSDictionary<NSString *, NSString *> * _Nullable)additionalParameters completionHandler:(void (^ _Nonnull)(SuccessfulTokenResponse * _Nullable, ErrorTokenResponse * _Nullable, NSError * _Nullable))completionHandler SWIFT_DEPRECATED_MSG("This function will not be supported in the next major version. Please use async fetchAccessToken");
...
///
- (void)refreshAccessTokenWith:(NSString * _Nonnull)refreshToken additionalParameters:(NSDictionary<NSString *, NSString *> * _Nullable)additionalParameters completionHandler:(void (^ _Nonnull)(SuccessfulTokenResponse * _Nullable, ErrorTokenResponse * _Nullable, NSError * _Nullable))completionHandler SWIFT_DEPRECATED_MSG("This function will not be supported in the next major version. Please use async refreshAccessToken");
...
///
- (void)revokeRefreshTokenWith:(NSString * _Nonnull)token completionHandler:(void (^ _Nonnull)(BOOL, NSError * _Nullable))completionHandler SWIFT_DEPRECATED_MSG("This function will not be supported in the next major version. Please use async revokeRefreshToken");
@end

/// A successful token response as defined in <a href="https://datatracker.ietf.org/doc/html/rfc6749#section-5">RFC 6749</a>.
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit23SuccessfulTokenResponse") SWIFT_AVAILABILITY(ios,introduced=14.0)
...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit27UnboundedTokenConfiguration") SWIFT_AVAILABILITY(ios,introduced=14.0)
