...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit7Problem") SWIFT_AVAILABILITY(ios,introduced=14.0)
...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit20AuthorizationProblem") SWIFT_AVAILABILITY(ios,introduced=14.0)
...
SWIFT_ENUM_FWD_DECL(NSInteger, HaapiAccessorOption)
...
SWIFT_PROTOCOL("_TtP15IdsvrHaapiUIKit17HaapiConfigurable_") SWIFT_AVAILABILITY(ios,introduced=14.0)
...
SWIFT_CLASS("_TtC15IdsvrHaapiUIKit19InvalidInputProblem") SWIFT_AVAILABILITY(ios,introduced=14.0)
